...
public abstract class LabEquipment{
    ...
    public void setManufacturer(String manufacturer) {
        if (manufacturer == null || manufacturer.isBlank()){
            throw new IllegalArgumentException("manufacurer cannot be null or blank");
        }
    ...
    public void setYear(int year) {
        if (year < MIN_YEAR){
            throw new IllegalArgumentException("year must be greater or equal to the minimum year");
        }
        this.year = year;
    }
